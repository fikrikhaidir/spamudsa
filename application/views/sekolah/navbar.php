...
<nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="<?php echo base_url() ?>index.php/sekolah/index">SMP Muhammadiyah 10</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="<?php echo base_url() ?>index.php/sekolah/index">Beranda</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url() ?>index.php/sekolah/tentang">Tentang</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url() ?>index.php/sekolah/kontak">Kontak</a>
                    </li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Akademik<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                          <li><a href="<?php echo base_url() ?>index.php/sekolah/staff">Staff Pengajar</a></li>
                          <li role="separator" class="divider"></li>
                          <li><a href="<?php echo base_url() ?>index.php/sekolah/prestasi">Prestasi</a></li>
                          <li role="separator" class="divider"></li>
