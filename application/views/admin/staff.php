...
<!--========================================================================================================== -->
                <div id="container">
                   <div id="body">
                            ...
                            <div class="col-md-3">
                               <div class="thumbnail">
                                  ...
                                  <div class="caption">
                                     ...
                                     <p>
                                        <?=anchor('admin/dashboard/staff_edit/'.$img->id_images,'Edit',['class'=>'btn btn-warning', 'role'=>'button'])?>
                                        <?=anchor('admin/dashboard/staff_hapus/'.$img->id_images,'Delete',['class'=>'btn btn-danger', 'role'=>'button','onclick'=>'return confirm(\'Are you sure?\')'])?>
                                     </p>
                                  </div>
                               </div>
                            </div>
                      ...
                      <?php else : ?>
                         <div align="center">We don't have any image yet, go ahead and <?=anchor('panel_staff/add','add a new one')?>.</div>
                      <?php endif; ?>
                   </div>
